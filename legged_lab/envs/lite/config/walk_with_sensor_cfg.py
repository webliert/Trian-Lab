...
@configclass
class TienKungWalkWithSensorAgentCfg(RslRlOnPolicyRunnerCfg):
    seed = 42
    device = "cuda:0"
    ...
    experiment_name = "walk_with_sensor"
    run_name = ""
    logger = "tensorboard"
    neptune_project = "walk_with_sensor"
    wandb_project = "walk_with_sensor"
    resume = False
    load_run = ".*"
