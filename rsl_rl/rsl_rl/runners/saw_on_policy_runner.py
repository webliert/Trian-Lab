...
import rsl_rl
from rsl_rl.algorithms import SAWPPO, Distillation
...
class SawOnPolicyRunner:
    ...
    def __init__(self, env: VecEnv, train_cfg: dict, log_dir: str | None = None, device="cpu"):
        ...
        if self.alg_cfg["class_name"] == "SAWPPO":
        ...
        policy: ActorCriticSaW | ActorCriticRecurrentSaW | StudentTeacher | StudentTeacherRecurrent = policy_class(
